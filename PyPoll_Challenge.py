...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        txt_file.write(county_results)
          ...
          # 6f: Write an if statement to determine the largest county turnout and get its vote count.
        if(votes > largest_turnout_county_count) and (vote_percentage > largest_turnout_percentage):
